...
const TRANSLATIONS = {
  en: {
    ...
    "filters.highlight": "Highlight manufacturers",
    "filters.highlight_hint": "Selected manufacturers' actuators are highlighted across scatter, radar, table, and the compare drawer.",
    "filters.highlight_clear": "Clear",
  ...
  zh: {
    ...
    "filters.highlight": "聚焦厂家",
    "filters.highlight_hint": "勾选的厂家旗下所有型号将在散点图、雷达图、表格与对比抽屉中以橙色突出显示。",
    "filters.highlight_clear": "清空",
